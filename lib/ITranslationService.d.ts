...
export type ITranslationService = Modify<Partial<i18n.i18n>, {
    ...
    t(key: string | string[], options?: ITranslationOptions): i18n.TFunctionReturn<i18n.Namespace, string | string[], ITranslationOptions>;
    t(key: string | string[], defaultValue: string, options?: ITranslationOptions): i18n.TFunctionReturn<i18n.Namespace, string | string[], ITranslationOptions>;
